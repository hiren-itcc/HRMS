...
/*
 * Base UI ships one `Close`; Radix shipped `Action` (confirm) and `Cancel`
 * (dismiss). Both close the dialog — the only difference is the button they
 * wear and whether they carry an onClick. Keeping the two names means the
 * confirm/dismiss intent stays readable at the call site, and 40 of them did
 * not have to move.
 */
...
export function AlertDialogCancel(props: AlertDialogPrimitive.Close.Props): React.ReactElement {
  return (
    <AlertDialogClose
