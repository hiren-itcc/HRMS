...
export function InputGroup({
  ...
  return (
    // <fieldset> requires a <legend> and is for grouping related controls;
    // this wraps one input with its addons — a visual grouping only.
...
export function InputGroupAddon({
  ...
  return (
    // Not a control: the handler only forwards a click on dead space to the
    // input beside it, the way a <label> does. There is nothing here for a
    // keyboard user to reach — the input itself is the tab stop.
