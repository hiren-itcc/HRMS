...
| ~~**AI features**~~ | ❌ **Out of scope by decision (2026-08-20)** — not being built in this project; removed from the plan the way LMS/Learning was | — | — |
...
| ~~Statutory return files (ECR, ESIC, TDS challans, Form 24Q)~~ | ❌ **Removed 2026-08-20 by scope decision.** Shipped in August and deleted the same month: this product deducts monthly TDS and provides the six statutory reports; generating government filing artefacts is out of scope. The 24Q generator was in any case gated on an untranscribed FVU layout and never produced a usable file. |
